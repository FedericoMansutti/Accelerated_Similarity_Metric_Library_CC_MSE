def test_sink_from_aie(kernel_count):
    # Original code parts
...
'''
    ...
    # Files array initialization
    files_array = 'std::ifstream files[] = {'
    files_array += ', '.join([f'file_in_{i}' for i in range(1, kernel_count * 2 + 1)]) + '};\n'
