...
void sum_kernels (input_stream<float>* restrict kernel_1, input_stream<float>* restrict kernel_2, input_stream<float>* restrict kernel_1, input_stream<float>* restrict kernel_2, output_stream<write_type>* restrict output);