...
// Kernel Stub Definition
  void my_kernel_function(input_stream<unsigned char> *,input_stream<unsigned char> *,output_stream<float> *) { /* Stub */ } 
  void sum_kernels(input_stream<float> *,input_stream<float> *,output_stream<float> *) { /* Stub */ } 
#endif
