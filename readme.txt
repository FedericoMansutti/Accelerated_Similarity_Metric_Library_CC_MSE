...
8)
Fill the files "img_ref.txt" and "img_float.txt" with the reference image and floating image. You can provide any size (2D or 3D) at the start of the files using width, height, and depth. They are already filled with a clear example.
...
10)
View the resulting metric computed by the AI Engine accelerator, which will be shown in the terminal.